...
const explosionButtonClassName = 'explosionButton';
...
class ExplositionGallery {
    ...
    initModal() {
        ...
        this.modalContainerNode.innerHTML = `
            <div class="${explosionSummaryClassName}">
                <div class="${explosionSummaryContentClassName}">
                    <a class="explosionButton" href="/Pages/catalog.html"><h2 class="${explosionTitleClassName}"></h2><a>              
            ...
            <div class="${explosionImagesClassName}">
                ${Array.from(this.linkNodes).map((linkNode) => `
                    ...
                    ${linkNode.dataset.title}" class="${explosionImageClassName}"
                    data-title="${linkNode.dataset.title}" data-description="
                    ${linkNode.dataset.description}"/>                      
                `).join('')}
            </div>
        `;
        ...
        this.explosionButtonNode = this.modalContainerNode.querySelector(`.${explosionButtonClassName}`);
    }
